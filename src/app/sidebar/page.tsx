...
import { BsHouseDoor, BsBarChart, BsBell, BsGraphUp } from "react-icons/bs";
    ...
    return (
        <div
            className={`${collapsed ? "w-20" : "w-64"
                } min-h-screen transition-all duration-300 bg-white ${darkMode ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"
                } shadow-md`}
        >
...
<button onClick={() => { toggleCollapse(); toggleMenu(); }} className="text-xl">
            ...
            <input
                ...
                className={`${collapsed ? "hidden" : "block"
                    } w-full px-4 py-2 mb-4 bg-gray-200 rounded-lg outline-none`}
            />
            ...
            <ul className="space-y-2">
                ...
                <li>
                    ...
                    >
                        <BsBell />
                        {!collapsed && <span>Panel Allocation</span>}
                    </a>
                </li>
            </ul>
